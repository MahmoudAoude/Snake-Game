import {collidedWithSelf} from './collision.js'
...
export default class Snake {
    ...
    updateTail(n) { // extends tail of snake by n
        const x = 0
        const y = 1
        let previousTailPosition = this.body[this.tailIndex]
    ...
    move(direction) {
        ...
        //this.setLastTailLocation(this.body[this.tailIndex][x], this.body[this.tailIndex][y]) //removed fOR TESTING (Useless)
